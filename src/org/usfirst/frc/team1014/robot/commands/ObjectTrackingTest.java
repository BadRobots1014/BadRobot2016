	...
	protected void execute() {
		if (Math.abs(ProcessedCam.getInstance().getTrackingScore()) >= 90) {
			if (Math.abs(ProcessedCam.getInstance().getX()) > 10) {
				double speed = (ProcessedCam.getInstance().getX() / 160 > 0.4) ? ProcessedCam.getInstance().getX() / 160
						: 0.4;
			...
			if (Math.abs(ProcessedCam.getInstance().getY()) > 10) {
				double speed = (ProcessedCam.getInstance().getY() / 120 > .1) ? ProcessedCam.getInstance().getY() / 120
						: .1;
